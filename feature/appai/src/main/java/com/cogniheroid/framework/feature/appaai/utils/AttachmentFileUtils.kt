package com.cogniheroid.framework.feature.appaai.utils
...
object AttachmentFileUtils {
    ...
    fun getAttachmentIconResId(attachmentContentType: AttachmentContentType): Int {
        return when (attachmentContentType) {

            AttachmentContentType.IMAGE -> {
                R.drawable.ic_zce_image
            }
            AttachmentContentType.MUSIC -> {
                R.drawable.ic_zce_music
            }
            AttachmentContentType.VIDEO -> {
                R.drawable.ic_zce_video
            }
            AttachmentContentType.TEXT -> {
                R.drawable.ic_zce_text
            }
            AttachmentContentType.ZIP -> {
                R.drawable.ic_zce_zip_file
            }
            AttachmentContentType.EXCEL -> {
                R.drawable.ic_zce_pdf
            }
    ...
    fun getAttachmentIntent(mediaType  : MediaType) : Intent {
